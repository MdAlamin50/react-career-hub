...
const Banner = () => {
    return (
        ...
        <img src="https://i.ibb.co/3T7dks7/P3-OLGJ1-copy-1.jpg" className="max-w-lg rounded-lg " />
          <div>
            <h1 className="text-6xl font-bold space-y-4">One Step <br /> Closer To Your <br /> <span className="text-[#7E90FE]">Dream Job</span></h1>
